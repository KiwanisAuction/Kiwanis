...
Public Class Item
    ...
    'Public Conn_CMD As String = "Data Source=kiwanisauction01.db.6809554.hostedresource.com; Initial Catalog=kiwanisauction01; User ID=kiwanisauction01; Password='Auction2011';" TESTING ONLY
    ...
    Private Sub cmdCommit(ByVal strCmd As String)
        ...
        Dim strItemID As String = cbItemID.SelectedItem
        ...
        Select Case strCmd
            ...
            Case "Save"     'Save changes made to current bidder
                SQLCmd.CommandType = CommandType.StoredProcedure
            ...
            Case "Delete"   'Delete current item
                ...
                SQLCmd.Parameters.AddWithValue("@itemid", cbItemID.SelectedItem)
            ...
            If SQLRead.HasRows Then
                ...
                While SQLRead.Read
                    If SQLRead("ItemDateDonated") > Main.dateLastYear Then
                        ...
                        cbItemID.Items.Add(SQLRead("ItemID"))
                        intCount += 1
                    End If
                End While

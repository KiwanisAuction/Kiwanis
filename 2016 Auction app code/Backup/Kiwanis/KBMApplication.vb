...
Public Class KBMApplication
    ...
    Private Sub Bidder_lb_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Bidder_lb.SelectedIndexChanged
        ...
        If Bidder_lb.SelectedItem.ToString <> "" Then
            ...
            If BidderIsKMember = True Then
                ...
                Member_lbl.Text = "Kawanis Member"
            End If
            loadItem(BidderID)
        End If
    ...
    Private Sub PhoneArea2_txt_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles PhoneArea2_txt.TextChanged
        If PhoneArea2_txt.TextLength = 3 Then
            PhonePrefix2_txt.Focus()
        End If
        '
        If IsValidAlphaNum(PhoneArea2_txt.Text) = True Then
            PhoneArea2_txt.BackColor = Color.LightGreen
            Warning_lbl.Text = "Letters are not valid input for phone number."
        Else
            Warning_lbl.Text = ""
        End If
    ...
    Private Sub PhonePrefix2_txt_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles PhonePrefix2_txt.TextChanged
        If PhonePrefix2_txt.TextLength >= 3 Then
            PhoneLine2_txt.Focus()
        ElseIf PhonePrefix2_txt.TextLength < 1 Then
            PhoneArea2_txt.Focus()
        End If
        '
        If IsValidAlphaNum(PhonePrefix2_txt.Text) = True Then
            PhonePrefix2_txt.BackColor = Color.LightGreen
            Warning_lbl.Text = "Letters are not valid input for phone number."
        Else
            Warning_lbl.Text = ""
        End If
    ...
    Private Sub PhoneLine2_txt_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles PhoneLine2_txt.TextChanged
        If PhoneLine2_txt.TextLength < 1 Then
            PhonePrefix2_txt.Focus()
        End If
        '
        If IsValidAlphaNum(PhoneLine2_txt.Text) = True Then
            PhoneLine2_txt.BackColor = Color.LightGreen
            Warning_lbl.Text = "Letters are not valid input for phone number."
        Else
            Warning_lbl.Text = ""
        End If
        ...
        Try
            If SQLRd.HasRows Then
                ...
                While SQLRd.Read
                    ...
                    Bidder_lb.Items.Add(SQLRd("BidderFName").ToString & " " & SQLRd("BidderLName").ToString)
    ...
    Public Sub HighlightErrors()
        ...
        End If
        '
        'Check for non-numeric input for Phone 1
        ...
        End If
        '
        'Check for non-numeric input for Phone 2
        If IsValidAlphaNum(PhoneArea2_txt.Text) = True Or IsValidAlphaNum(PhonePrefix2_txt.Text) = True Or IsValidAlphaNum(PhoneLine2_txt.Text) = True Then
            PhoneArea2_txt.BackColor = Color.LightGreen
            PhonePrefix2_txt.BackColor = Color.LightGreen
            PhoneLine2_txt.BackColor = Color.LightGreen
            ErrMsgStr += "Letters are not valid input for phone number." & vbCr
        ElseIf IsValidAlphaNum(PhonePrefix2_txt.Text) = True Or IsValidAlphaNum(PhoneLine2_txt.Text) = True Then
            PhonePrefix2_txt.BackColor = Color.LightGreen
            PhoneLine2_txt.BackColor = Color.LightGreen
            ErrMsgStr += "Letters are not valid input for phone number." & vbCr
        ElseIf IsValidAlphaNum(PhoneLine2_txt.Text) = True Then
            PhoneLine2_txt.BackColor = Color.LightGreen
            ErrMsgStr += "Letters are not valid input for phone number." & vbCr
        End If
        '

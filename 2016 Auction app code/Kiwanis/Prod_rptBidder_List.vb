...
Public Class Prod_rptBidder_List
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Prod_rptBidder_List.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Kiwanis.Prod_rptBidder_List.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedProd_rptBidder_List
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Prod_rptBidder_List = New Prod_rptBidder_List()
        rpt.Site = Me.Site
        Return rpt
    End Function

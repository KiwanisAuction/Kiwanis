...
Public Class Prod_rptBlock_Review
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Prod_rptBlock_Review.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Kiwanis.Prod_rptBlock_Review.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedProd_rptBlock_Review
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Prod_rptBlock_Review = New Prod_rptBlock_Review()
        rpt.Site = Me.Site
        Return rpt
    End Function

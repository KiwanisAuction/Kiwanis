...
Public Class PlaceBid
    ...
    Private Sub txtBidderID_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtBidderID.TextChanged
        ...
        If IsValidAlphaNum(txtBidderID.Text) = True Then
            ...
            'Show a message when a letter is entered and clear the text box to be ready
            MessageBox.Show("Letters are not valid input for a bidder ID.")
            txtBidderID.Clear()
            btnCheck.Enabled = False
        ElseIf String.IsNullOrEmpty(txtBidderID.Text) = True Then
            btnCheck.Enabled = False
        Else

...
Public Class Prod_rptDonor_List
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Kiwanis.Prod_rptDonor_List.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedProd_rptDonor_List
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Prod_rptDonor_List = New Prod_rptDonor_List()
        rpt.Site = Me.Site
        Return rpt
    End Function

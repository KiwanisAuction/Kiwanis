...
Public Class Prod_rptTop3Bids
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Kiwanis.Prod_rptTop3Bids.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_auctiondate() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedProd_rptTop3Bids
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Prod_rptTop3Bids = New Prod_rptTop3Bids
        rpt.Site = Me.Site
        Return rpt
    End Function

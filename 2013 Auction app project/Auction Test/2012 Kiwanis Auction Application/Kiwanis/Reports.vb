...
Public Class Reports
    ...
    Private Sub loadReport(ByVal reportNum)
        ...
        'Dim DB_Server As String = KiwanisConfig.DataSource
        'Dim DB_Database As String = KiwanisConfig.DataBase
        'Dim DB_User As String = KiwanisConfig.User
        'Dim DB_Pass As String = KiwanisConfig.Pass
        ...
        Try
            ...
            'rpt.SetDatabaseLogon("SQL2008R2_785987_tvauction_user", "aWkshun") ' Static DB logon for Crystal

...
Public Class K_DBCC
    ...
    Private Sub Save_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Save_btn.Click
        ...
        Main.btnAuctioneer.Enabled = KiwanisConfig.GetConfigValue("cAuctDirectiveEnabled")
        Main.Button1.Enabled = KiwanisConfig.GetConfigValue("cAddEditDonorEnable")
        Main.Button2.Enabled = KiwanisConfig.GetConfigValue("cAddEditItemEnable")
        Main.Button3.Enabled = KiwanisConfig.GetConfigValue("cAddEditBidderEnable")
        Main.Button4.Enabled = KiwanisConfig.GetConfigValue("cAddEditBlockEnable")
        Main.Button5.Enabled = KiwanisConfig.GetConfigValue("cAssignItemBlockEnable")
        Main.Button6.Enabled = KiwanisConfig.GetConfigValue("cViewBidEnable")
        Main.btnPlaceBid.Enabled = KiwanisConfig.GetConfigValue("cPlaceBidEnable")
        Main.Button7.Enabled = KiwanisConfig.GetConfigValue("cAddEditKiwanianEnable")
        Main.Report_btn.Enabled = KiwanisConfig.GetConfigValue("cReportsEnable")

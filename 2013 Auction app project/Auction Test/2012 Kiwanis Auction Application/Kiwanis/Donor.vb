...
Public Class Donor
    ...
    Private Sub loadDonorID()
        ...
        Try
            If SQLRead.HasRows Then
                ...
                While SQLRead.Read
                    If SQLRead("DonorNotActive").ToString = "False" And cbxViewNotActive.Checked = False Then
                    ...
                    Else
                        'DO NOTHING
                    End If
                    If cbxViewNotActive.Checked = True Then
    ...
    Private Sub loadKiwanisMem()
        ...
        SQLCmd.CommandText = "SELECT MemberID, MemLName, MemFName, MemMidInit FROM KiwanisMembers order by MemLName"
    ...
    Private Sub PhoneExt_txt_KeyPress(ByVal sender As System.Object, ByVal e As KeyPressEventArgs) Handles PhoneExt_txt.KeyPress
        If Not ((IsNumeric(e.KeyChar)) Or (e.KeyChar = ChrW(Keys.Back))) Then
            e.KeyChar = ""
        End If
    End Sub
    ...
    End Sub
End Class
'Dim DBConnectionString As String = "Data Source=sql2k804.discountasp.net; Initial Catalog=SQL2008R2_785987_tvauction ; User ID=devteam; Password='WsUdev2011';"
'Dim DBConnectionString As String = "Data Source=kiwanisauction01.db.6809554.hostedresource.com; Initial Catalog=kiwanisauction01; User ID=kiwanisauction01; Password='Auction2011';"
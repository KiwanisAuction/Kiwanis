...
Public Class Block
    ...
    Public arBlock(9999, 6) As String
    ...
    Private Sub getSponsorID()
        ...
        Try
            ...
            If SQLRead.HasRows Then
                While SQLRead.Read
                    cbSponsorID.Items.Add(SQLRead("DonorID"))
                End While
            End If
            SQLConn.Close()
    ...
    Private Sub ButtonCommand(ByVal strCmd As String)
        ...
        Dim strBlockDuration As String = txtDuration.Text
        ...
        Select Case strCmd
            Case "Add"      'Add new block
                ...
                If blnOkToCommit = True Then
                    SQLCmd.CommandText = "INSERT INTO Blocks (BlockName, BlockType, BlockTypeDesc, BlockAuctioneer, BlockSponsorID, BlockSchedDuration)" & _
                                                                "VALUES ('" & strBlockName & "', '" & strBlockType & "', '" & strBlockTypeDesc & "' ," & _
                                                                "'" & strBlockAuctioneer & "' ,'" & strSponsorID & "' ,'" & strBlockDuration & "')"
                    Try
                        SQLConn.Open()
            ...
            Case "Save"     'Save changes made to current block
                SQLCmd.CommandText = "UPDATE Blocks SET " & _
                                            ...
                                            "BlockSchedDuration = '" & strBlockDuration & "'" & _
    ...
    Private Sub loadBlockID()
        ...
        Dim strBlockID, strBlockName, strBlockType, strBlockTypeDes, strBlockAuctioneer, strBlockSponsorID, strBlockDuration As String
        ...
        Try
            ...
            If SQLRead.HasRows Then
                ...
                While SQLRead.Read
                    ...
                    strBlockDuration = SQLRead("BlockSchedDuration").ToString
                    ...
                    arBlock(intCount, 6) = strBlockDuration
    ...
    Private Sub cbBlockID_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cbBlockID.SelectedIndexChanged
        ...
        If cbBlockID.SelectedItem.ToString <> "" Then
            ...
            txtDuration.Text = arBlock(intPos, 6).ToString
        Else
            btnCommit.Enabled = True
            btnCommitDelete.Enabled = True
        End If
    ...
    Private Sub setDurationForBlockType()
    ...
    Private Sub loadBlockType()
        ...
        Try
            ...
            If SQLRead.HasRows Then
                While SQLRead.Read
                    cbBlockType.Items.Add(SQLRead("BlockType"))
                End While
            End If
            SQLConn.Close()
        Catch ex As Exception
    ...
    Private Sub txtBlockDesc_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtBlockDesc.TextChanged
        lblCharRemain.Text = (200 - txtBlockDesc.Text.Length)
    End Sub
